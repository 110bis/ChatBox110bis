...
class Lab extends StatelessWidget {
  ...
  static const String name = "110 bis, lab d'innovation de l'éducation nationale";
  static const List<String> test = [//""];
    ...
    "button 4"];//,"button 5", "button 6", "button 7", "button 8", "button 9", "button 10", "button 11", "button 12", "button 13", "button 14", "button 15", "button 16", "button 17", "button 18", "button 19", "button 20"];
  static const List<String> test1 = [//""];
    ...
    "coucou 4.png"];//, "button 5", "button 6", "button 7", "button 8", "button 9", "button 10", "button 11", "button 12", "button 13", "button 14", "button 15", "button 16", "button 17", "button 18", "button 19", "button 20"];
